...
define('modules/wall',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-auth'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaAuth) {
    'use strict';
    ...
    var Wall = exports.Wall = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaAuth.AuthService), _dec(_class = function () {
        function Wall(router, auth) {
